...
const createMockStats = (inviteStatuses: LabeledSiteCount[]): Stats => ({
  ...
  ontimeCheckinPercentageTotal: 0,
  checkinCompletedAverageTotal: 0,
  invitesTotal: 0,
  completedCheckinsTotal: 0,
  offendersTotal: 0,
  flaggedCheckinsTotal: 0,
  stoppedCheckinsTotal: 0,
  completedDay1Total: 0,
  completedDay1Percentage: 0,
  completedDay2Total: 0,
  completedDay2Percentage: 0,
  completedDay3Total: 0,
  completedDay3Percentage: 0,
  expiredCheckinsTotal: 0,
  expiredCheckinsPercentageTotal: 0,
  checkinOutsideAccessTotal: 0,
  automatedIdCheckAccuracyTotal: 0,
  automatedIdCheckAccuracyPercentageTotal: 0,
  flaggedCheckinsPercentageTotal: 0,
  frequencyWeeklyTotal: 0,
  frequencyFortnightlyTotal: 0,
  frequency4WeeksTotal: 0,
  frequency8WeeksTotal: 0,
})
